...
public class SpecificTickerResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof SpecificTickerResponse)) return false;
        final SpecificTickerResponse other = (SpecificTickerResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof SpecificTickerResponse;
    }
    ...
    public String toString() {
        return "SpecificTickerResponse(exchangeType=" + this.getExchangeType() + ", ticker=" + this.getTicker() + ", lastResp=" + this.isLastResp() + ")";
    }

    @SuppressWarnings("all")
    public SpecificTickerResponse() {
    }

    @SuppressWarnings("all")
    public SpecificTickerResponse(final ExchangeType exchangeType, final String ticker, final boolean lastResp) {
