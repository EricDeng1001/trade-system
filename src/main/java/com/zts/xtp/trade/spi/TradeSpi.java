...
public interface TradeSpi {
     ...
     * @param sessionId 资金账户对应的sessionId，登录时得到
     */
    default void onQueryOrderByPage(OrderResponse orderInfo, long reqCount, long orderSequence, long queryReference, String sessionId){}
     ...
     * @param sessionId 资金账户对应的sessionId，登录时得到
     */
    default void onQueryTradeByPage(TradeResponse tradeInfo, long reqCount, long tradeSequence, long queryReference, String sessionId){}
